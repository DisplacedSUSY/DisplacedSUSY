...
DenHistogramObj = inputFileMC.Get("TTbarControlRegionMETTriggerPlotter/Electron-muon Plots/electronEtaMuonEta")
NumHistogramObj = inputFileMC.Get("TTbarControlRegionMETTriggerPassEMuTriggerPlotter/Electron-muon Plots/electronEtaMuonEta")
...
outputFile = TFile("DataMCRatioEtaOneBin_Muon.root", "RECREATE")
DenHistogramObj = inputFileData.Get("TTbarControlRegionMETTriggerPlotter/Electron-muon Plots/electronEtaMuonEta")
NumHistogramObj = inputFileData.Get("TTbarControlRegionMETTriggerPassEMuTriggerPlotter/Electron-muon Plots/electronEtaMuonEta")
NumHistogram = NumHistogramObj.Clone().ProjectionX("Num",0,-1,"e")
DenHistogram = DenHistogramObj.Clone().ProjectionX("Den",0,-1,"e")
xBins = array('d',[0,0.2,0.4,0.6,1.0,1.4,1.8,2.4])
#xBins = array('d',[0,2.4])
...
outputFile = TFile("DataMCRatioEta_Electron.root", "RECREATE")
DenHistogramObj = inputFileData.Get("TTbarControlRegionMETTriggerPlotter/Electron-muon Plots/electronEtaMuonEta")
NumHistogramObj = inputFileData.Get("TTbarControlRegionMETTriggerPassEMuTriggerPlotter/Electron-muon Plots/electronEtaMuonEta")
NumHistogram = NumHistogramObj.Clone().ProjectionY("Num",0,-1,"e")
DenHistogram = DenHistogramObj.Clone().ProjectionY("Den",0,-1,"e")
