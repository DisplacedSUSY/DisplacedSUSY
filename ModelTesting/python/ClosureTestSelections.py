...
SignalGenMatching_KynCuts_CrossCuts_NoChargeProduct = cms.PSet(
    name = cms.string("SignalGenMatching_KynCuts_CrossCuts_NoChargeProduct"),
    cuts = cms.VPSet ()
    )

SignalGenMatching_KynCuts_CrossCuts_NoChargeProduct.cuts.extend(copy.deepcopy(SignalGenMatching_KynCuts_CrossCuts.cuts))
for cut in SignalGenMatching_KynCuts_CrossCuts_NoChargeProduct.cuts:
    if "chargeProduct" in str(cut.cutString):
                cut.cutString = cms.string('chargeProduct > -3')# this cut should have no effect now
...
### wihtout charge product
SignalGenMatching_KynCuts_CrossCuts_FullPreselection_NoTrigger_NoChargeProduct = cms.PSet(
        name = cms.string("SignalGenMatching_KynCuts_CrossCuts_FullPreselection_NoTrigger_NoChargeProduct"),
            cuts = cms.VPSet ()
            )

SignalGenMatching_KynCuts_CrossCuts_FullPreselection_NoTrigger_NoChargeProduct.cuts.extend(copy.deepcopy(SignalGenMatching_KynCuts_CrossCuts_FullPreselection_NoTrigger.cuts))
for cut in SignalGenMatching_KynCuts_CrossCuts_FullPreselection_NoTrigger_NoChargeProduct.cuts:
    if "chargeProduct" in str(cut.cutString):
                        cut.cutString = cms.string('chargeProduct > -3')# this cut should have no effect now
...
SignalGenMatching_KynCuts_CrossCuts_FullPreselection_NoTrigger_Mixte = cms.PSet(
        name = cms.string("SignalGenMatching_KynCuts_CrossCuts_FullPreselection_NoTrigger_Mixte"),
        #        triggers = cms.vstring("HLT_Mu22_Photon22_CaloIdL_v"), # TRIGGER  
        cuts = cms.VPSet (
        # EVENT CLEANING
        cms.PSet (
        ...
        cms.PSet (
        inputCollection = cms.string("mcparticle-secondary mcparticle pairs"),
        cutString = cms.string("chargeProduct < 3"),
        numberRequired = cms.string("== 1")
        ),
        # ELECTRON AND MUON ARE NOT OVERLAPPING
        cms.PSet (
        ...
        # ELECTRON NOT OVERLAPPING WITH JET
        cms.PSet (
        inputCollection = cms.string("mcparticle-jet pairs"),
        cutString = cms.string("deltaR < 0.5"),
        numberRequired = cms.string("== 0"),
        isVeto = cms.bool(True),
        alias = cms.string("mcparticle near jet veto"),
...
### pair order importance (a-b pair vs b-a pair)
### On gen quantity only and wihtout the analysis cut on lepton
SignalGenMatching_KynCuts_CrossCuts_a_b_Pair = cms.PSet(
        name = cms.string("SignalGenMatching_KynCuts_CrossCuts_a_b_Pair"),
        cuts = cms.VPSet (
        # EVENT CLEANING
        cms.PSet (
        inputCollection = cms.string("events"),
...
### On gen quantity only and wihtout the analysis cut on lepton
SignalGenMatching_KynCuts_CrossCuts_b_a_Pair = cms.PSet(
        name = cms.string("SignalGenMatching_KynCuts_CrossCuts_b_a_Pair"),
        cuts = cms.VPSet (
        # EVENT CLEANING
        cms.PSet (
        inputCollection = cms.string("events"),
        ...
        # OPPOSITE SIGN E-MU PAIR
        cms.PSet (
        inputCollection = cms.string("secondary mcparticle-mcparticle pairs"), # what input collection?
        cutString = cms.string("chargeProduct < 3"),
        numberRequired = cms.string("== 1")
        ),
        # ELECTRON AND MUON ARE NOT OVERLAPPING
