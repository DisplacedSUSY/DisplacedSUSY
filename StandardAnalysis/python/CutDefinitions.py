...
# electron d0 > 10 microns
electron_d0_greaterThan10_cut = cms.PSet(
    inputCollection = cms.vstring("electrons","beamspots"),
    cutString = cms.string("10000*abs("+electronSmearedD0WRTBeamspot+") > 10"),
    numberRequired = cms.string(">= 1"),
    alias = cms.string(">=1 electrons with |d_0| > 10 mum")
...
# muon d0 > 20 microns
muon_d0_greaterThan20_cut = cms.PSet(
    inputCollection = cms.vstring("muons","beamspots"),
    cutString = cms.string("10000*abs("+muonSmearedD0WRTBeamspot+") > 20"),
    numberRequired = cms.string(">= 1"),
    alias = cms.string(">=1 muons with |d_0| > 20 mum")
    )
...
muon_d0_lessThan10cm_cut = cms.PSet(
    inputCollection = cms.vstring("muons","beamspots"),
    cutString = cms.string("abs("+muonSmearedD0WRTBeamspot+") < 10"),
    numberRequired = cms.string(">= 1"),
    alias = cms.string(">=1 muons with |d_0| < 10 cm")
    )
...
emu_noDispVtxsInMaterial_cut = cms.PSet(
   inputCollection = cms.vstring("eventvariables"),
   cutString = cms.string("nDispEMuVtxsInMaterial == 0 || (nDispEMuVtxsInMaterial==1 & vtxEMuChisqInMaterial>20.)"),
   numberRequired = cms.string(">= 1"),
   alias = cms.string("no good emu vertices in material")
)
ee_noDispVtxsInMaterial_cut = cms.PSet(
   inputCollection = cms.vstring("eventvariables"),
   cutString = cms.string("nDispEEVtxsInMaterial == 0 || (nDispEEVtxsInMaterial==1 & vtxEEChisqInMaterial>20.)"),
   numberRequired = cms.string(">= 1"),
   alias = cms.string("no good ee vertices in material")
)
