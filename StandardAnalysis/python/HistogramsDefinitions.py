...
electronHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("electronpassConversionVeto"),
            title = cms.string("Electron Pass Conversion Flag;passConversionVeto"),
            binsX = cms.untracked.vdouble(4, -2, 2),
            inputVariables = cms.vstring("electron.passConversionVeto"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            name = cms.string("electronDxySignificanceSmall"),
        ...
        cms.PSet (
            name = cms.string("electronAbsDxySignificanceSmall"),
            title = cms.string("Electron Dxy Significance; electron d_{xy}/#delta_{d_{xy}}"),
            binsX = cms.untracked.vdouble(200, 0, 2),
        ...
        cms.PSet (
            name = cms.string("electronDxySignificanceMedium"),
            title = cms.string("Electron Dxy Significance; electron d_{xy}/#delta_{d_{xy}}"),
            binsX = cms.untracked.vdouble(100, -5, 5),
            inputVariables = cms.vstring('((-(electron.vx - beamspot.x0)*electron.py + (electron.vy - beamspot.y0)*electron.px)/electron.pt)/hypot(electron.gsfTrack.d0Error, hypot(beamspot.x0Error, beamspot.y0Error))'),
        ),
        cms.PSet (
            name = cms.string("electronAbsDxySignificanceMedium"),
            title = cms.string("Electron Dxy Significance; electron d_{xy}/#delta_{d_{xy}}"),
            binsX = cms.untracked.vdouble(50, 0, 5),
            inputVariables = cms.vstring('abs(((-(electron.vx - beamspot.x0)*electron.py + (electron.vy - beamspot.y0)*electron.px)/electron.pt)/hypot(electron.gsfTrack.d0Error, hypot(beamspot.x0Error, beamspot.y0Error)))'),
        ),
        cms.PSet (
            name = cms.string("electronDxySignificanceLarge"),
            title = cms.string("Electron Dxy Significance; electron d_{xy}/#delta_{d_{xy}}"),
            binsX = cms.untracked.vdouble(100, -10, 10),
            inputVariables = cms.vstring('((-(electron.vx - beamspot.x0)*electron.py + (electron.vy - beamspot.y0)*electron.px)/electron.pt)/hypot(electron.gsfTrack.d0Error, hypot(beamspot.x0Error, beamspot.y0Error))'),
        ),
        cms.PSet (
            name = cms.string("electronAbsDxySignificanceLarge"),
            title = cms.string("Electron Dxy Significance; electron d_{xy}/#delta_{d_{xy}}"),
            binsX = cms.untracked.vdouble(50, 0, 10),
            inputVariables = cms.vstring('abs(((-(electron.vx - beamspot.x0)*electron.py + (electron.vy - beamspot.y0)*electron.px)/electron.pt)/hypot(electron.gsfTrack.d0Error, hypot(beamspot.x0Error, beamspot.y0Error)))'),
        ),
        ...
        cms.PSet (
            name = cms.string("electronAbsDxySignificance"),
            title = cms.string("Electron Dxy Significance; electron d_{xy}/#delta_{d_{xy}}"),
            binsX = cms.untracked.vdouble(200, -10, 10),
            inputVariables = cms.vstring('abs(((-(electron.vx - beamspot.x0)*electron.py + (electron.vy - beamspot.y0)*electron.px)/electron.pt)/hypot(electron.gsfTrack.d0Error, hypot(beamspot.x0Error, beamspot.y0Error)))'),
        ),
