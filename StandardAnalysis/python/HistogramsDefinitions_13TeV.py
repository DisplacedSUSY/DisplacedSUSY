...
electronHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, 0, 0.01),
            inputVariables = cms.vstring("abs((-(candele.vx - beamspot.x0)*candele.py + (candele.vy - beamspot.y0)*candele.px))/candele.pt"),
        ),
        cms.PSet (
...
electronMuonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(50, 0, 5),
            inputVariables = cms.vstring("abs(candele.eta - muon.eta)"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            inputVariables = cms.vstring("muon.pt","candele.pt"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            inputVariables = cms.vstring("(muon.pfIsolationR04_.sumChargedHadronPt + max(0.0,muon.pfIsolationR04_.sumNeutralHadronEt + muon.pfIsolationR04_.sumPhotonEt - 0.5*muon.pfIsolationR04_.sumPUPt))/muon.pt","(candele.pfIso_.sumChargedHadronPt + max(0.0,candele.pfIso_.sumNeutralHadronEt + candele.pfIso_.sumPhotonEt - candele.rho*candele.AEff))/candele.pt")
        ),
    )
)
