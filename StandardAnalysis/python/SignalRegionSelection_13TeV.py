...
##########################################################################
##########################################################################
SignalRegionSelection_13TeV = cms.PSet(
    name = cms.string("SignalRegionSelection13TeV"),
    ...
    cuts = cms.VPSet (
        ...
        cms.PSet (
            ...
            numberRequired = cms.string(">= 1"),
            alias = cms.string("muon displaced")
        ),
        # ELECTRON DISPLACED
        cms.PSet (
            ...
            numberRequired = cms.string(">= 1"),
            alias = cms.string("electron displaced")
        ),
...
##########################################################################
SignalRegionInclusiveDisplacedTriggerSelection_13TeV = cms.PSet(
    name = cms.string("SignalRegionInclusiveDisplacedTriggerSelection13TeV"),
    triggers = cms.vstring("HLT_Mu38NoFiltersNoVtx_Photon38_CaloIdL_v"), # TRIGGER
    cuts = cms.VPSet ()
)
SignalRegionInclusiveDisplacedTriggerSelection_13TeV.cuts = cms.VPSet (copy.deepcopy(SignalRegionSelection_13TeV.cuts))

for cut in SignalRegionInclusiveDisplacedTriggerSelection_13TeV.cuts:
...
SignalRegionDisplacedTriggerSelection_13TeV = cms.PSet(
    name = cms.string("SignalRegionDisplacedTriggerSelection13TeV"),
    triggers = cms.vstring("HLT_Mu28NoFiltersNoVtxDisplaced_Photon28_CaloIdL_v"), # TRIGGER
    cuts = cms.VPSet ()
)
SignalRegionDisplacedTriggerSelection_13TeV.cuts = cms.VPSet (copy.deepcopy(SignalRegionSelection_13TeV.cuts))

for cut in SignalRegionDisplacedTriggerSelection_13TeV.cuts:
    if "pt > 25" in str(cut.cutString) and "candeles" in str(cut.inputCollection):
