...
signal_region_no_os_cuts = cms.VPSet(
    # MUON DXY 
    cms.PSet (
        inputCollection = cms.vstring("muons","beamspots"),
        cutString = cms.string("abs((-(muon.vx - beamspot.x0)*muon.py + (muon.vy - beamspot.y0)*muon.px)/muon.pt) >= 0.02 "),
...
SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger = cms.PSet(
    name = cms.string("SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger"),
    triggers = cms.vstring("HLT_Mu38NoFiltersNoVtx_Photon38_CaloIdL_v"), # TRIGGER
    cuts = cms.VPSet ()
)

SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger.cuts.extend(electron_basic_selection_cuts)
SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger.cuts.append(electron_loose_iso_cut)
SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger.cuts.extend(muon_basic_selection_cuts)
SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger.cuts.append(muon_loose_iso_cut)
SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger.cuts.extend(signal_region_no_os_cuts)
for cut in SignalRegionSelectionNoIsoNoOSInclusiveDisplacedTrigger.cuts:
    if "pt > 25" in str(cut.cutString) and "electrons" in str(cut.inputCollection):
        cut.cutString = cms.string("pt > 42")
    if "pt > 25" in str(cut.cutString) and "muons" in str(cut.inputCollection):
        cut.cutString = cms.string("pt > 40")

SignalRegionSelectionNoOSInclusiveDisplacedTrigger = cms.PSet(
    name = cms.string("SignalRegionSelectionNoOSInclusiveDisplacedTrigger"),
    triggers = cms.vstring("HLT_Mu38NoFiltersNoVtx_Photon38_CaloIdL_v"), # TRIGGER
    cuts = cms.VPSet ()
)

SignalRegionSelectionNoOSInclusiveDisplacedTrigger.cuts.extend(electron_basic_selection_cuts)
SignalRegionSelectionNoOSInclusiveDisplacedTrigger.cuts.append(electron_iso_cut)
SignalRegionSelectionNoOSInclusiveDisplacedTrigger.cuts.extend(muon_basic_selection_cuts)
SignalRegionSelectionNoOSInclusiveDisplacedTrigger.cuts.append(muon_iso_cut)
SignalRegionSelectionNoOSInclusiveDisplacedTrigger.cuts.extend(signal_region_no_os_cuts)
for cut in SignalRegionSelectionNoOSInclusiveDisplacedTrigger.cuts:
    if "pt > 25" in str(cut.cutString) and "electrons" in str(cut.inputCollection):
        cut.cutString = cms.string("pt > 42")
    if "pt > 25" in str(cut.cutString) and "muons" in str(cut.inputCollection):
        cut.cutString = cms.string("pt > 40")

SignalRegionSelectionNoIsoInclusiveDisplacedTrigger = cms.PSet(
    name = cms.string("SignalRegionSelectionNoIsoInclusiveDisplacedTrigger"),
    triggers = cms.vstring("HLT_Mu38NoFiltersNoVtx_Photon38_CaloIdL_v"), # TRIGGER
    cuts = cms.VPSet ()
)

SignalRegionSelectionNoIsoInclusiveDisplacedTrigger.cuts.extend(electron_basic_selection_cuts)
SignalRegionSelectionNoIsoInclusiveDisplacedTrigger.cuts.append(electron_loose_iso_cut)
SignalRegionSelectionNoIsoInclusiveDisplacedTrigger.cuts.extend(muon_basic_selection_cuts)
SignalRegionSelectionNoIsoInclusiveDisplacedTrigger.cuts.append(muon_loose_iso_cut)
SignalRegionSelectionNoIsoInclusiveDisplacedTrigger.cuts.extend(signal_region_cuts)
for cut in SignalRegionSelectionNoIsoInclusiveDisplacedTrigger.cuts:
    if "pt > 25" in str(cut.cutString) and "electrons" in str(cut.inputCollection):
        cut.cutString = cms.string("pt > 42")
    if "pt > 25" in str(cut.cutString) and "muons" in str(cut.inputCollection):
        cut.cutString = cms.string("pt > 40")
