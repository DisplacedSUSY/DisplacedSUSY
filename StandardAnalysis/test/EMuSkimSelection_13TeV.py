...
variableProducers.append("CandidateJetProducer")
...
add_channels (process, eventSelections, cms.VPSet (), collections,variableProducers, True)
...
process.CandidateJetProducer = cms.EDProducer("CandidateJetProducer",
