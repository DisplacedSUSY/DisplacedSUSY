...
from DisplacedSUSY.StandardAnalysis.SignalRegionSelection_13TeV import *
import math
import os
...
process.source = cms.Source ('PoolSource',
  fileNames = cms.untracked.vstring (
    ...
    'file:/data/users/bing/condor/EMuSkim_Oct19th/MuonEG_2015D_v3/EMuSKim13TeV/skim_0.root',
  )
)
...
eventSelections = []
eventSelections.append(SignalRegionInclusiveDisplacedTriggerSelection_13TeV)
#eventSelections.append(SignalRegionDisplacedTriggerSelection_13TeV)
...
muonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(200, -0.02, 0.02),
...
electronMuonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("muonIpVsElectronIp"),
            title = cms.string("Muon Ip vs Electron Ip;d_{xy}_{mu} [CM]"),
            binsX = cms.untracked.vdouble(1000,0,10),
            binsY = cms.untracked.vdouble(1000,0,10),
            inputVariables = cms.vstring("abs((-(candele.vx - beamspot.x0)*candele.py + (candele.vy - beamspot.y0)*candele.px)/candele.pt)","abs((-(muon.vx - beamspot.x0)*candele.py + (muon.vy - beamspot.y0)*muon.px)/muon.pt)"),
        ),
    )
)
