...
if ($CMSSW_VERSION == 'CMSSW_8_0_21') then
    echo "Detected CMSSW 8_0_21. Calculating 2016 PU"
...
else if ($CMSSW_VERSION == 'CMSSW_9_4_8') then
    echo "Detected CMSSW 9_4_8. Calculating 2017 PU"
