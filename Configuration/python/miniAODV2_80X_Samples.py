...
signal_mc_samples = {
    ...
    'stop1800_1mm'   : "/DisplacedSUSY_stopToBottom_M_1800_1mm_TuneCUETP8M1_13TeV_pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3-v1/MINIAODSIM",
...
def renameReweightedSamples(dataset_names):
    ...
    for sample in signal_datasets:
        ...
        dataset_names[sample] = dataset_names["{}_{:g}mm".format(base_name, src_ctau)]
