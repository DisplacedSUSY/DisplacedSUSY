...
MuonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("muonLeadingEtaLeadingPhi"),
            title = cms.string("Leading Muon Eta vs. Leading Muon Phi;Leading muon #phi;Leading muon #eta"),
            binsX = cms.untracked.vdouble(64, -3.2, 3.2),
            binsY = cms.untracked.vdouble(60, -3, 3),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonSubleadingEtaSubleadingPhi"),
            title = cms.string("Subleading muon Eta vs. Subleading muon Phi;Subleading muon #phi;Subleading muon #eta"),
            binsX = cms.untracked.vdouble(64, -3.2, 3.2),
            binsY = cms.untracked.vdouble(60, -3, 3),
            indexX = cms.untracked.int32(1),
        ...
        cms.PSet (
            ...
            title = cms.string("Muon Global Track Normalized Chi Squared;Muon global track #chi^{2}/ndf"),
        ...
        cms.PSet (
            name = cms.string("muonNumberOfValidPixelHitsPhi"),
            title = cms.string("Muon number of valid pixel hits vs. Muon Phi;Muon #phi;Muon number of valid pixel hits"),
            binsX = cms.untracked.vdouble(64, -3.2, 3.2),
            binsY = cms.untracked.vdouble(10, 0, 10),
            inputVariables = cms.vstring("phi","innerTrack.hitPattern_.numberOfValidPixelHits"),
        ),
        cms.PSet (
            name = cms.string("muonLeadingNumberOfValidPixelHitsLeadingPhi"),
            title = cms.string("Leading muon number of valid pixel hits vs. Leading muon Phi;Leading muon #phi;Leading muon number of valid pixel hits"),
            binsX = cms.untracked.vdouble(64, -3.2, 3.2),
            binsY = cms.untracked.vdouble(10, 0, 10),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonSubleadingNumberOfValidPixelHitsSubleadingPhi"),
            title = cms.string("Subleading muon number of valid pixel hits vs. Subleading muon Phi;Subleading muon #phi;Subleading muon number of valid pixel hits"),
            binsX = cms.untracked.vdouble(64, -3.2, 3.2),
            binsY = cms.untracked.vdouble(10, 0, 10),
            indexX = cms.untracked.int32(1),
            indexY = cms.untracked.int32(1),
        ...
        cms.PSet (
            #returns the layer number of the first valid pixel hit
            #if it is 0, then there are no valid pixel hits
            name = cms.string("muonLayerOfFirstValidPixelHit"),
            title = cms.string("Layer Number of First Valid Pixel Hit for Muons;Layer number of first valid pixel hit for muons"),
...
ElectronHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("electronLeadingEtaLeadingPhi"),
            title = cms.string("Leading Electron Eta vs. Leading Electron Phi;Leading electron #phi;Leading electron #eta"),
            binsX = cms.untracked.vdouble(64, -3.2, 3.2),
            binsY = cms.untracked.vdouble(60, -3, 3),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronSubleadingEtaSubleadingPhi"),
            title = cms.string("Subleading Electron Eta vs. Subleading Electron Phi;Subleading electron #phi;Subleading electron #eta"),
            binsX = cms.untracked.vdouble(64, -3.2, 3.2),
            binsY = cms.untracked.vdouble(60, -3, 3),
            indexX = cms.untracked.int32(1),
            indexY = cms.untracked.int32(1),
        ...
        cms.PSet (
            name = cms.string("electronNumberOfValidHits"),
            title = cms.string("Electron Number of Valid Hits;Electron number of valid Hits"),
            binsX = cms.untracked.vdouble(40, 0, 40),
            inputVariables = cms.vstring("gsfTrack.hitPattern_.numberOfValidHits"),
        ),
        cms.PSet (
            name = cms.string("electronNumberOfValidPixelHits"),
            title = cms.string("Electron Number of Valid Pixel Hits;Electron number of valid pixel hits"),
            binsX = cms.untracked.vdouble(10, 0, 10),
            inputVariables = cms.vstring("gsfTrack.hitPattern_.numberOfValidPixelHits"),
        ),
        cms.PSet (
            name = cms.string("electronTrackerLayersWithMeasurement"),
            title = cms.string("Electron Number of Tracker Layer with Measurement;Electron tracker layers with measurement"),
            binsX = cms.untracked.vdouble(30, 0, 30),
            inputVariables = cms.vstring("gsfTrack.hitPattern_.trackerLayersWithMeasurement"),
            ),
        cms.PSet (
            #returns the layer number of the first valid pixel hit
            #if it is 0, then there are no valid pixel hits
            name = cms.string("electronLayerOfFirstValidPixelHit"),
            title = cms.string("Layer Number of First Valid Pixel Hit for Electrons;Layer number of first valid pixel hit for electrons"),
            binsX = cms.untracked.vdouble(5, -0.5, 4.5),
            inputVariables = cms.vstring("layerOfFirstValidPixelHit"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Electron deltaEtaSuperClusterTrackAtVtx;Electron #Delta#eta(SC, track) at vertex"),
        ...
        cms.PSet (
            ...
            title = cms.string("Electron deltaPhiSuperClusterTrackAtVtx;Electron #Delta#phi(SC, track) at vertex"),
        ...
        cms.PSet (
            ...
            title = cms.string("Electron full5x5_sigmaIetaIeta;Electron #sigmai#etai#eta"),
            binsX = cms.untracked.vdouble(100, 0, 0.1),
            inputVariables = cms.vstring("full5x5_sigmaIetaIeta"),
        ),
        cms.PSet (
            name = cms.string("electronHadronicOverEm"),
            title = cms.string("Electron H/E;Electron H/E"),
            binsX = cms.untracked.vdouble(100, 0, 0.5),
            inputVariables = cms.vstring("hadronicOverEm"),
        ),
        cms.PSet (
            name = cms.string("electronOoEmooP"),
            title = cms.string("Electron 1/E - 1/p;Electron 1/E - 1/p [GeV^{-1}]"),
            binsX = cms.untracked.vdouble(100, 0, 0.5),
            inputVariables = cms.vstring("abs(1/ecalEnergy - eSuperClusterOverP/ecalEnergy)"),
        ),
        cms.PSet (
            name = cms.string("electronVtxFitConversion"),
            title = cms.string("Electron Pass Conversion Veto;Electron passes conversion veto"),
            binsX = cms.untracked.vdouble(2, 0, 2),
            inputVariables = cms.vstring("passConversionVeto"),
        ),
        cms.PSet (
            name = cms.string("electronNormalizedChi2"),
            title = cms.string("Electron Track Normalized Chi Squared;Electron GSF track #chi^{2}/ndof"),
...
ElectronMuonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("electronNewRhoBasedIsolation[0]_vs_muonRhoBasedIsolation[0]"),
            title = cms.string("Leading electron new rho-based Isolation vs. leading muon rho-based Isolation;Leading muon rho-based isolation;Leading electron new rho-based isolation"),
            binsX = cms.untracked.vdouble(100, 0, 1.0),
            binsY = cms.untracked.vdouble(100, 0, 1.0),
            inputVariables = cms.vstring(objectDefs.muon_iso_string,objectDefs.electron_newIso_string),
        ),
    )
)
...
# create lists of bin edges for 10cm d0 TH2s
...
pt_bins = range(0, 200, 10) + range(200, 1000, 100) + range(1000, 5001, 2000)
...
ElectronD0Histograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_500um_vs_electronAbsD0Sig[0]_50"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron |d_{0}/#sigma(d_{0})|;Leading electron |d_{0}/#sigma(d_{0})|;Leading electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 50),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_5000um_vs_electronAbsD0Sig[0]_500"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron |d_{0}/#sigma(d_{0})|;Leading electron |d_{0}/#sigma(d_{0})|;Leading electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_500um_vs_electronTrackD0Error[0]_500"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron #sigma(d_{0});Leading electron #sigma(d_{0}) [#mum];Leading electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D d0 vs. pt
        cms.PSet (
            name = cms.string("electronD0[0]_vs_electronPt[0]"),
            title = cms.string("Leading electron d_{0} vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron d_{0} [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D abs(d0) vs. pt
        cms.PSet (
            name = cms.string("electronAbsD0[0]_500um_vs_electronPt[0]_200"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_1000um_vs_electronPt[0]_500"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 1000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_10000um_vs_electronPt[0]_1000"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 1000),
            binsY = cms.untracked.vdouble(100, 0, 10000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_500um_vs_electronPt[0]_200_coarse"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron |d_{0}| [#mum];"),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_1000um_vs_electronPt[0]_500_coarse"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron |d_{0}| [#mum];"),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_10000um_vs_electronPt[0]_1000_coarse"),
            title = cms.string("Leading electron |d_{0}| vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron |d_{0}| [#mum];"),
        ...
        # 2D sig(d0) vs. pt
        cms.PSet (
            name = cms.string("electronD0Sig[0]_vs_electronPt[0]"),
            title = cms.string("Leading electron d_{0}/#sigma(d_{0}) vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron d_{0}/#sigma(d_{0})"),
            binsX = cms.untracked.vdouble(100, 0, 200),
        ...
        cms.PSet (
            name = cms.string("electronTrackD0Error[0]_vs_electronPt[0]"),
            title = cms.string("Leading electron track #sigma(d_{0}) vs. leading electron p_{T};Leading electron p_{T} [GeV];Leading electron track #sigma(d_{0}) [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D d0 vs. eta
        cms.PSet (
            name = cms.string("electronD0[0]_vs_electronEta[0]"),
            title = cms.string("Leading electron d_{0} vs. leading electron #eta;Leading electron #eta;Leading electron d_{0} [#mum]"),
        ...
        # 2D sig(d0) vs. eta
        cms.PSet (
            name = cms.string("electronD0Sig[0]_vs_electronEta[0]"),
            title = cms.string("Leading electron d_{0}/#sigma(d_{0}) vs. leading electron #eta;Leading electron #eta;Leading electron d_{0}/#sigma(d_{0})"),
            binsX = cms.untracked.vdouble(100, -3, 3),
            binsY = cms.untracked.vdouble(100, -20, 20),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronTrackD0Error[0]_vs_electronEta[0]"),
            title = cms.string("Leading electron track #sigma(d_{0}) vs. leading electron #eta;Leading electron #eta;Leading electron track #sigma(d_{0}) [#mum]"),
            binsX = cms.untracked.vdouble(100, -3, 3),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D d0 vs. phi
        cms.PSet (
            name = cms.string("electronD0[0]_50um_vs_electronPhi[0]"),
            title = cms.string("Leading electron d_{0} vs. leading electron #phi;Leading electron #phi;Leading electron d_{0} [#mum]"),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_500um_vs_electronPhi[0]"),
            title = cms.string("Leading electron d_{0} vs. leading electron #phi;Leading electron #phi;Leading electron d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -3.14, 3.14),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        # 2D sig(d0) vs. phi
        cms.PSet (
            name = cms.string("electronD0Sig[0]_vs_electronPhi[0]"),
            title = cms.string("Leading electron d_{0}/#sigma(d_{0}) vs. leading electron #phi;Leading electron #phi;Leading electron d_{0}/#sigma(d_{0})"),
            binsX = cms.untracked.vdouble(100, -3.14, 3.14),
            binsY = cms.untracked.vdouble(100, -20, 20),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronTrackD0Error[0]_vs_electronPhi[0]"),
            title = cms.string("Leading electron track #sigma(d_{0}) vs. leading electron #phi;Leading electron #phi;Leading electron track #sigma(d_{0}) [#mum]"),
            binsX = cms.untracked.vdouble(100, -3.14, 3.14),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_vs_electronAbsD0[1]_100000um_vs_electronPt[0]"),
            ...
            binsX = cms.untracked.vdouble(coarse_100000um_bins),
            binsY = cms.untracked.vdouble(coarse_100000um_bins),
            binsZ = cms.untracked.vdouble(pt_bins),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(1),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_vs_electronAbsD0[1]_100000um_vs_electronPt[1]"),
        ...
        #2D pull vs reco pt
        cms.PSet (
            name = cms.string("electronD0pull[0]_50um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco d_{0} - gen d_{0} vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -50, 50),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0pull[0]_100um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco d_{0} - gen d_{0} vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
        ...
        cms.PSet (
            name = cms.string("electronD0pull[0]_200um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco d_{0} - gen d_{0} vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
        ...
        cms.PSet (
            name = cms.string("electronD0pull[0]_500um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco d_{0} - gen d_{0} vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0pullAbs[0]_50um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco |d_{0}| - gen |d_{0}| vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -50, 50),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0pullAbs[0]_100um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco |d_{0}| - gen |d_{0}| vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -100, 100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0pullAbs[0]_200um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco |d_{0}| - gen |d_{0}| vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -200, 200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0pullAbs[0]_500um_vs_electronPt[0]"),
            title = cms.string("Leading electron reco |d_{0}| - gen |d_{0}| vs leading electron reco p_{T}; Leading electron reco p_{T} [GeV]; Leading electron |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_10um_vs_electronGenD0[0]_10um"),
            title = cms.string("Leading electron reco d_{0} vs. leading electron gen d_{0}; Leading electron gen d_{0} [#mum]; Leading electron reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -10, 10),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_50um_vs_electronGenD0[0]_50um"),
            title = cms.string("Leading electron reco d_{0} vs. leading electron gen d_{0}; Leading electron gen d_{0} [#mum]; Leading electron reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -50, 50),
            binsY = cms.untracked.vdouble(100, -50, 50),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_100um_vs_electronGenD0[0]_100um"),
            title = cms.string("Leading electron reco d_{0} vs. leading electron gen d_{0}; Leading electron gen d_{0} [#mum]; Leading electron reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -100, 100),
            binsY = cms.untracked.vdouble(100, -100, 100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_200um_vs_electronGenD0[0]_200um"),
            title = cms.string("Leading electron reco d_{0} vs. leading electron gen d_{0}; Leading electron gen d_{0} [#mum]; Leading electron reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -200, 200),
            binsY = cms.untracked.vdouble(100, -200, 200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_500um_vs_electronGenD0[0]_500um"),
            title = cms.string("Leading electron reco d_{0} vs. leading electron gen d_{0}; Leading electron gen d_{0} [#mum]; Leading electron reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -500, 500),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_1000um_vs_electronGenD0[0]_1000um"),
            title = cms.string("Leading electron reco d_{0} vs. leading electron gen d_{0}; Leading electron gen d_{0} [#mum]; Leading electron reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -1000, 1000),
        ...
        cms.PSet (
            name = cms.string("electronD0[0]_5000um_vs_electronGenD0[0]_5000um"),
            title = cms.string("Leading electron reco d_{0} vs. leading electron gen d_{0}; Leading electron gen d_{0} [#mum]; Leading electron reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -5000, 5000),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_10um_vs_electronAbsGenD0[0]_10um"),
            title = cms.string("Leading electron reco |d_{0}| vs. leading electron gen |d_{0}|; Leading electron gen |d_{0}| [#mum]; Leading electron reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 10),
            binsY = cms.untracked.vdouble(100, 0, 10),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_50um_vs_electronAbsGenD0[0]_50um"),
            title = cms.string("Leading electron reco |d_{0}| vs. leading electron gen |d_{0}|; Leading electron gen |d_{0}| [#mum]; Leading electron reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 50),
            binsY = cms.untracked.vdouble(100, 0, 50),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_100um_vs_electronAbsGenD0[0]_100um"),
            title = cms.string("Leading electron reco |d_{0}| vs. leading electron gen |d_{0}|; Leading electron gen |d_{0}| [#mum]; Leading electron reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 100),
            binsY = cms.untracked.vdouble(100, 0, 100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_200um_vs_electronAbsGenD0[0]_200um"),
            title = cms.string("Leading electron reco |d_{0}| vs. leading electron gen |d_{0}|; Leading electron gen |d_{0}| [#mum]; Leading electron reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, 0, 200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_500um_vs_electronAbsGenD0[0]_500um"),
            title = cms.string("Leading electron reco |d_{0}| vs. leading electron gen |d_{0}|; Leading electron gen |d_{0}| [#mum]; Leading electron reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_1000um_vs_electronAbsGenD0[0]_1000um"),
            title = cms.string("Leading electron reco |d_{0}| vs. leading electron gen |d_{0}|; Leading electron gen |d_{0}| [#mum]; Leading electron reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 1000),
            binsY = cms.untracked.vdouble(100, 0, 1000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsD0[0]_5000um_vs_electronAbsGenD0[0]_5000um"),
            title = cms.string("Leading electron reco |d_{0}| vs. leading electron gen |d_{0}|; Leading electron gen |d_{0}| [#mum]; Leading electron reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 5000),
            binsY = cms.untracked.vdouble(100, 0, 5000),
            indexX = cms.untracked.int32(0),
        ...
        #gen 3D
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_electronAbsGenD0[1]_100000um_vs_electronGenPt[0]"),
...
MuonD0Histograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        # 2D abs(d0) vs. abs(sig(d0))
        cms.PSet (
            name = cms.string("muonAbsD0[0]_500um_vs_muonAbsD0Sig[0]_50"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon |d_{0}/#sigma(d_{0})|;Leading muon |d_{0}/#sigma(d_{0})|;Leading muon |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 50),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_5000um_vs_muonAbsD0Sig[0]_500"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon |d_{0}/#sigma(d_{0})|;Leading muon |d_{0}/#sigma(d_{0})|;Leading muon |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 5000),
            indexX = cms.untracked.int32(0),
        ...
        # 2D abs(d0) vs. d0 error
        cms.PSet (
            name = cms.string("muonAbsD0[0]_500um_vs_muonTrackD0Error[0]_500"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon #sigma(d_{0});Leading muon #sigma(d_{0}) [#mum];Leading muon |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D d0 vs. pt
        cms.PSet (
            name = cms.string("muonD0[0]_vs_muonPt[0]"),
            title = cms.string("Leading muon d_{0} vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon d_{0} [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D abs(d0) vs. pt
        cms.PSet (
            name = cms.string("muonAbsD0[0]_500um_vs_muonPt[0]_200"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_1000um_vs_muonPt[0]_500"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 1000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_10000um_vs_muonPt[0]_1000"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(100, 0, 1000),
            binsY = cms.untracked.vdouble(100, 0, 10000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_500um_vs_muonPt[0]_200_coarse"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(20, 0, 200),
            binsY = cms.untracked.vdouble(20, 0, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_1000um_vs_muonPt[0]_500_coarse"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(20, 0, 500),
            binsY = cms.untracked.vdouble(20, 0, 1000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_10000um_vs_muonPt[0]_1000_coarse"),
            title = cms.string("Leading muon |d_{0}| vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon |d_{0}| [#mum];"),
            binsX = cms.untracked.vdouble(20, 0, 1000),
            binsY = cms.untracked.vdouble(20, 0, 10000),
            indexX = cms.untracked.int32(0),
        ...
        # 2D sig(d0) vs. pt
        cms.PSet (
            name = cms.string("muonD0Sig[0]_vs_muonPt[0]"),
            title = cms.string("Leading muon d_{0}/#sigma(d_{0}) vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon d_{0}/#sigma(d_{0})"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -20, 20),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D abs( sig(d0) ) vs. pt
        cms.PSet (
            name = cms.string("muonAbsD0Sig[0]_vs_muonPt[0]"),
            title = cms.string("Leading muon |d_{0}/#sigma(d_{0})| vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon |d_{0}/#sigma(d_{0})|"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        # 2D track d0 error vs. pt
        cms.PSet (
            name = cms.string("muonTrackD0Error[0]_vs_muonPt[0]"),
            title = cms.string("Leading muon track #sigma(d_{0}) vs. leading muon p_{T};Leading muon p_{T} [GeV];Leading muon track #sigma(d_{0}) [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D d0 vs. eta
        cms.PSet (
            name = cms.string("muonD0[0]_vs_muonEta[0]"),
            title = cms.string("Leading muon d_{0} vs. leading muon #eta;Leading muon #eta;Leading muon d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -3, 3),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D sig(d0) vs. eta
        cms.PSet (
            name = cms.string("muonD0Sig[0]_vs_muonEta[0]"),
            title = cms.string("Leading muon d_{0}/#sigma(d_{0}) vs. leading muon #eta;Leading muon #eta;Leading muon d_{0}/#sigma(d_{0})"),
            binsX = cms.untracked.vdouble(100, -3, 3),
            binsY = cms.untracked.vdouble(100, -20, 20),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D track d0 error vs. eta
        cms.PSet (
            name = cms.string("muonTrackD0Error[0]_vs_muonEta[0]"),
            title = cms.string("Leading muon track #sigma(d_{0}) vs. leading muon #eta;Leading muon #eta;Leading muon track #sigma(d_{0}) [#mum]"),
            binsX = cms.untracked.vdouble(100, -3, 3),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D d0 vs. phi
        cms.PSet (
            name = cms.string("muonD0[0]_50um_vs_muonPhi[0]"),
            title = cms.string("Leading muon d_{0} vs. leading muon #phi;Leading muon #phi;Leading muon d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -3.14, 3.14),
            binsY = cms.untracked.vdouble(100, -50, 50),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0[0]_500um_vs_muonPhi[0]"),
            title = cms.string("Leading muon d_{0} vs. leading muon #phi;Leading muon #phi;Leading muon d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -3.14, 3.14),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        # 2D sig(d0) vs. phi
        cms.PSet (
            name = cms.string("muonD0Sig[0]_vs_muonPhi[0]"),
            title = cms.string("Leading muon d_{0}/#sigma(d_{0}) vs. leading muon #phi;Leading muon #phi;Leading muon d_{0}/#sigma(d_{0})"),
            binsX = cms.untracked.vdouble(100, -3.14, 3.14),
            binsY = cms.untracked.vdouble(100, -20, 20),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        # 2D track d0 error vs. phi
        cms.PSet (
            name = cms.string("muonTrackD0Error[0]_vs_muonPhi[0]"),
            title = cms.string("Leading muon track #sigma(d_{0}) vs. leading muon #phi;Leading muon #phi;Leading muon track #sigma(d_{0}) [#mum]"),
            binsX = cms.untracked.vdouble(100, -3.14, 3.14),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_vs_muonAbsD0[1]_100000um_vs_muonPt[0]"),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_vs_muonAbsD0[1]_100000um_vs_muonPt[1]"),
        ...
        #gen 3D
        cms.PSet (
            name = cms.string("muonAbsGenD0[0]_vs_muonAbsGenD0[1]_100000um_vs_muonGenPt[0]"),
        ...
        #2D pull vs reco pt
        cms.PSet (
            name = cms.string("muonD0pull[0]_50um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco d_{0} - gen d_{0} vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -50, 50),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0pull[0]_100um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco d_{0} - gen d_{0} vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -100, 100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0pull[0]_200um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco d_{0} - gen d_{0} vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -200, 200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0pull[0]_500um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco d_{0} - gen d_{0} vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon d_{0} pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0pullAbs[0]_50um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco |d_{0}| - gen |d_{0}| vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -50, 50),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0pullAbs[0]_100um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco |d_{0}| - gen |d_{0}| vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -100, 100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0pullAbs[0]_200um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco |d_{0}| - gen |d_{0}| vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -200, 200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0pullAbs[0]_500um_vs_muonPt[0]"),
            title = cms.string("Leading muon reco |d_{0}| - gen |d_{0}| vs leading muon reco p_{T}; Leading muon reco p_{T} [GeV]; Leading muon |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0[0]_10um_vs_muonGenD0[0]_10um"),
            title = cms.string("Leading muon reco d_{0} vs. leading muon gen d_{0}; Leading muon gen d_{0} [#mum]; Leading muon reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -10, 10),
            binsY = cms.untracked.vdouble(100, -10, 10),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0[0]_100um_vs_muonGenD0[0]_100um"),
            title = cms.string("Leading muon reco d_{0} vs. leading muon gen d_{0}; Leading muon gen d_{0} [#mum]; Leading muon reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -100, 100),
            binsY = cms.untracked.vdouble(100, -100, 100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0[0]_200um_vs_muonGenD0[0]_200um"),
            title = cms.string("Leading muon reco d_{0} vs. leading muon gen d_{0}; Leading muon gen d_{0} [#mum]; Leading muon reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -200, 200),
            binsY = cms.untracked.vdouble(100, -200, 200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0[0]_500um_vs_muonGenD0[0]_500um"),
            title = cms.string("Leading muon reco d_{0} vs. leading muon gen d_{0}; Leading muon gen d_{0} [#mum]; Leading muon reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -500, 500),
            binsY = cms.untracked.vdouble(100, -500, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0[0]_1000um_vs_muonGenD0[0]_1000um"),
            title = cms.string("Leading muon reco d_{0} vs. leading muon gen d_{0}; Leading muon gen d_{0} [#mum]; Leading muon reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -1000, 1000),
            binsY = cms.untracked.vdouble(100, -1000, 1000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonD0[0]_5000um_vs_muonGenD0[0]_5000um"),
            title = cms.string("Leading muon reco d_{0} vs. leading muon gen d_{0}; Leading muon gen d_{0} [#mum]; Leading muon reco d_{0} [#mum]"),
            binsX = cms.untracked.vdouble(100, -5000, 5000),
            binsY = cms.untracked.vdouble(100, -5000, 5000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_10um_vs_muonAbsGenD0[0]_10um"),
            title = cms.string("Leading muon reco |d_{0}| vs. leading muon gen |d_{0}|; Leading muon gen |d_{0}| [#mum]; Leading muon reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 10),
            binsY = cms.untracked.vdouble(100, 0, 10),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_50um_vs_muonAbsGenD0[0]_50um"),
            title = cms.string("Leading muon reco |d_{0}| vs. leading muon gen |d_{0}|; Leading muon gen |d_{0}| [#mum]; Leading muon reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 50),
            binsY = cms.untracked.vdouble(100, 0, 50),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_100um_vs_muonAbsGenD0[0]_100um"),
            title = cms.string("Leading muon reco |d_{0}| vs. leading muon gen |d_{0}|; Leading muon gen |d_{0}| [#mum]; Leading muon reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 100),
            binsY = cms.untracked.vdouble(100, 0, 100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_200um_vs_muonAbsGenD0[0]_200um"),
            title = cms.string("Leading muon reco |d_{0}| vs. leading muon gen |d_{0}|; Leading muon gen |d_{0}| [#mum]; Leading muon reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, 0, 200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_500um_vs_muonAbsGenD0[0]_500um"),
            title = cms.string("Leading muon reco |d_{0}| vs. leading muon gen |d_{0}|; Leading muon gen |d_{0}| [#mum]; Leading muon reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_1000um_vs_muonAbsGenD0[0]_1000um"),
            title = cms.string("Leading muon reco |d_{0}| vs. leading muon gen |d_{0}|; Leading muon gen |d_{0}| [#mum]; Leading muon reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 1000),
            binsY = cms.untracked.vdouble(100, 0, 1000),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_5000um_vs_muonAbsGenD0[0]_5000um"),
            title = cms.string("Leading muon reco |d_{0}| vs. leading muon gen |d_{0}|; Leading muon gen |d_{0}| [#mum]; Leading muon reco |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100, 0, 5000),
            binsY = cms.untracked.vdouble(100, 0, 5000),
            indexX = cms.untracked.int32(0),
...
ElectronMuonD0Histograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_vs_electronAbsD0[0]_100000um_vs_muonPt[0]"),
        ...
        cms.PSet (
            name = cms.string("muonAbsD0[0]_vs_electronAbsD0[0]_100000um_vs_electronPt[0]"),
        ...
        #gen
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_10um"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100,0,10),
            binsY = cms.untracked.vdouble(100,0,10),
            indexX = cms.untracked.int32(0),
            indexY = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_50um"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100,0,50),
            binsY = cms.untracked.vdouble(100,0,50),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_100um"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100,0,100),
            binsY = cms.untracked.vdouble(100,0,100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_200um"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100,0,200),
            binsY = cms.untracked.vdouble(100,0,200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_500um"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(100,0,500),
            binsY = cms.untracked.vdouble(100,0,500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_2000um"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_10um_coarse"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(10,0,10),
            binsY = cms.untracked.vdouble(10,0,10),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_50um_coarse"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(10,0,50),
            binsY = cms.untracked.vdouble(10,0,50),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_100um_coarse"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(10,0,100),
            binsY = cms.untracked.vdouble(10,0,100),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_200um_coarse"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(10,0,200),
            binsY = cms.untracked.vdouble(10,0,200),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_500um_coarse"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
            binsX = cms.untracked.vdouble(10,0,500),
            binsY = cms.untracked.vdouble(10,0,500),
            indexX = cms.untracked.int32(0),
        ...
        cms.PSet (
            name = cms.string("electronAbsGenD0[0]_vs_muonAbsGenD0[0]_2000um_coarse"),
            title = cms.string("Leading gen electron |d_{0}| vs. Leading gen muon |d_{0}|;Leading gen muon |d_{0}| [#mum];Leading gen electron |d_{0}| [#mum]"),
        ...
        #gen 3D
        cms.PSet (
            name = cms.string("muonAbsGenD0[0]_vs_electronAbsGenD0[0]_100000um_vs_muonGenPt[0]"),
        ...
        cms.PSet (
            name = cms.string("muonAbsGenD0[0]_vs_electronAbsGenD0[0]_100000um_vs_electronGenPt[0]"),
...
eventMuonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        cms.PSet (
            name = cms.string("muonPt[0]_vs_tagMuonPt"),
            title = cms.string("Leading muon p_{T} vs tag muon p_{T}; tag muon p_{T} [GeV]; Leading muon p_{T} [GeV]"),
            binsX = cms.untracked.vdouble(100, 0, 500),
            binsY = cms.untracked.vdouble(100, 0, 500),
            indexY = cms.untracked.int32(0),
