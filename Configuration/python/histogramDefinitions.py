...
ElectronD0Histograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, -50, 50),
            inputVariables = cms.vstring("10000*"+electronD0WRTBeamspot+" - 10000*electron.genD0"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Electron reco |d_{0}| - gen |d_{0}|; Electron |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, -50, 50),
            inputVariables = cms.vstring("10000*abs("+electronD0WRTBeamspot+") - 10000*abs(electron.genD0)"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            inputVariables = cms.vstring("electron.pt", "10000*"+electronD0WRTBeamspot+" - 10000*electron.genD0"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -50, 50),
            inputVariables = cms.vstring("electron.pt", "10000*abs("+electronD0WRTBeamspot+") - 10000*abs(electron.genD0)"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            inputVariables = cms.vstring("10000*electron.genD0", "10000*"+electronD0WRTBeamspot),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, 0, 10),
            binsY = cms.untracked.vdouble(100, 0, 10),
            inputVariables = cms.vstring("10000*abs(electron.genD0)", "10000*abs("+electronD0WRTBeamspot+")"),
        ),
        cms.PSet (
...
MuonD0Histograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, -50, 50),
            inputVariables = cms.vstring("10000*"+muonD0WRTBeamspot+" - 10000*muon.genD0"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Muon reco |d_{0}| - gen |d_{0}|; Muon |d_{0}| pull [#mum]"),
            binsX = cms.untracked.vdouble(100, -50, 50),
            inputVariables = cms.vstring("10000*abs("+muonD0WRTBeamspot+") - 10000*abs(muon.genD0)"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -50, 50),
            inputVariables = cms.vstring("muon.pt", "10000*"+muonD0WRTBeamspot+" - 10000*muon.genD0"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, 0, 200),
            binsY = cms.untracked.vdouble(100, -50, 50),
            inputVariables = cms.vstring("muon.pt", "10000*abs("+muonD0WRTBeamspot+") - 10000*abs(muon.genD0)"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, -10, 10),
            binsY = cms.untracked.vdouble(100, -10, 10),
            inputVariables = cms.vstring("10000*muon.genD0", "10000*"+muonD0WRTBeamspot),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            binsX = cms.untracked.vdouble(100, 0, 10),
            binsY = cms.untracked.vdouble(100, 0, 10),
            inputVariables = cms.vstring("10000*abs(muon.genD0)", "10000*abs("+muonD0WRTBeamspot+")"),
        ),
        cms.PSet (
