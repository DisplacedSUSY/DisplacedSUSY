...
inputDir1 = "/data/users/lantonel/condor/EMu_PRC_Skim"
inputDir2 = "/data/users/lantonel/condor/EMuPCR_Feb21"

#datasets1 = filter(lambda x: os.path.isdir(os.path.join(inputDir1, x)), os.listdir(inputDir1))

datasets1 = ["MuonEG_2016B",
              "MuonEG_2016C",
              "MuonEG_2016D",
              "MuonEG_2016E",
              "MuonEG_2016F",
...
#            print "!!!"
            ...
            file1 = subprocess.Popen(['tail','-10',dir1+file_], stdout=subprocess.PIPE,stderr=subprocess.PIPE).stdout.readlines()
#            print file1
