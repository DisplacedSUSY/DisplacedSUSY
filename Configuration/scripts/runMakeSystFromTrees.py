...
# 2016
    ...
    os.system('scram runtime -sh')
    os.chdir('DisplacedSUSY/EMuChannel/test')
    os.system('../../Configuration/scripts/makeSystematicTextFileFromTrees.py -l PreselectionOptions.py -w EMuPreselection_2016Analysis_Signal_9Dec2020 -s pileup')
    os.system('../../Configuration/scripts/makeSystematicTextFileFromTrees.py -l PreselectionOptions.py -w EMuPreselection_2016Analysis_Signal_9Dec2020 -s electronIDandIso')
    os.system('../../Configuration/scripts/makeSystematicTextFileFromTrees.py -l PreselectionOptions.py -w EMuPreselection_2016Analysis_Signal_9Dec2020 -s muonIDandIso')
    ...
    os.chdir('../../MuMuChannel/test')
    os.system('../../Configuration/scripts/makeSystematicTextFileFromTrees.py -l PreselectionOptions.py -w MuMuPreselection_2016Analysis_Signal_9Dec2020 -s pileup')
    os.system('../../Configuration/scripts/makeSystematicTextFileFromTrees.py -l PreselectionOptions.py -w MuMuPreselection_2016Analysis_Signal_9Dec2020 -s muonIDandIso')
