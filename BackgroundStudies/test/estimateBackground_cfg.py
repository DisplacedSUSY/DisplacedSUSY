...
sidebands = [
    {
        ...
        "displaced" : {
            "file" : "/data/users/bcardwell/condor/QCDElectronCR_17_11_02/SingleEle_2016_postHIP.root",
            "hist" : "QCDElectronControlRegionPlotter/Electron Plots/electronAbsD0_10cm",
            "name" : "Displaced Electron Background",
        },
        "sideband" : {
            "file" : "/data/users/bcardwell/condor/EMu_Sidebands_17_11_03/MuonEG_2016_postHIP.root",
            "hist" : "PreselectionPromptMuonPlotter/Electron Plots/electronAbsD0_10cm",
    ...
    },
    {
        ...
        "sideband" : {
            "file" : "/data/users/bcardwell/condor/EMu_Sidebands_17_11_03/MuonEG_2016_postHIP.root",
            "hist" : "PreselectionPromptElectronPlotter/Muon Plots/muonAbsD0_10cm",
            "name" : "Muon Sideband",
        },
    },
]
