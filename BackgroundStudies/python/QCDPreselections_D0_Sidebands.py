...
Preselection_AntiIsoExtraReduced_Displaced_Electron = cms.PSet(
    name = cms.string("Preselection_AntiIsoExtraReduced_Displaced_Electron"),
...
Preselection_AntiIsoExtraReduced_Displaced_Muon = cms.PSet(
    name = cms.string("Preselection_AntiIsoExtraReduced_Displaced_Muon"),
    triggers = cms.vstring("HLT_Mu22_Photon22_CaloIdL_v"),
    cuts = cms.VPSet (
      cms.PSet (
        inputCollection = cms.string("events"),
