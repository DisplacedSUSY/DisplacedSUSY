...
PARTICLE_FILE = 'DisplacedSUSY/SignalMC/data/geant4_staus_%s_BBBmm.txt'  % (MASS_POINT)
USE_REGGE = False
GRIDPACK = '/srv/staus_%s_slc6_amd64_gcc700_CMSSW_10_2_24_patch1_tarball.tar.xz' % (MASS_POINT)
SLHA_TABLE="""
##******************************************************************
##                      MadGraph/MadEvent                          *
##******************************************************************
