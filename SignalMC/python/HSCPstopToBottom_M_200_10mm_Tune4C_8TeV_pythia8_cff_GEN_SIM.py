...
# with command line options: HSCPstopToBottom_M_200_10mm_Tune4C_8TeV_pythia8_cff --step GEN,SIM --beamspot Realistic8TeVCollision --conditions START53_V7C::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent RAWSIM --datatier GEN-SIM -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('HSCPstopToBottom_M_200_10mm_Tune4C_8TeV_pythia8_cff nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HSCPstopToBottom_M_200_10mm_Tune4C_8TeV_pythia8_cff_GEN_SIM.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    SLHAFileForPythia8 = cms.string('Configuration/Generator/data/HSCP_stopToBottom_200_10.0mm_SLHA.spc'),
    ...
    slhaFile = cms.untracked.string('Configuration/Generator/data/HSCP_stopToBottom_200_10.0mm_SLHA.spc'),
