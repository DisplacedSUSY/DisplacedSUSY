...
#foreach i (300 500 600 800 900 1000 1100 1200 1600)
    ...
    #sed "s/XXX/$i/" crab_step4_stopToLB_M_XXX_0p1mm_2016MC.py > crab_step4_stopToLB_M_${i}_0p1mm_2016MC.py
    #sed "s/XXX/$i/" crab_step4_stopToLD_M_XXX_0p1mm_2016MC.py > crab_step4_stopToLD_M_${i}_0p1mm_2016MC.py
    #sed "s/XXX/$i/" crab_step4_stopToLD_M_XXX_0p1mm_2016MC_TaskB.py > crab_step4_stopToLD_M_${i}_0p1mm_2016MC.py
    ...
    #crab submit crab_step4_stopToLB_M_${i}_0p1mm_2016MC.py
    ...
    crab status -d crab/crab_stopToLB_M_${i}_0p1mm_13TeV_2016MC_MiniAod
    #crab status -d crab/crab_stopToLD_M_${i}_0p1mm_13TeV_2016MC_MiniAod
    #crab resubmit -d crab/crab_stopToLD_M_${i}_0p1mm_13TeV_2016MC_MiniAod
    #crab status -d crab/crab_stopToLD_M_${i}_0p1mm_13TeV_2016MC_MiniAod_TaskB
