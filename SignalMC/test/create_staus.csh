...
foreach i (100)
	...
	#crab resubmit -d crab/crab_staus_leptonFilter_M_${i}_${j}mm_13TeV_2018MC_GenSim
	...
	#crab resubmit -d crab/crab_staus_leptonFilter_M_${i}_${j}mm_13TeV_2018MC_DigiRawHlt
	...
	#crab resubmit -d crab/crab_staus_leptonFilter_M_${i}_${j}mm_13TeV_2018MC_Reco
	...
	#crab resubmit -d crab/crab_staus_leptonFilter_M_${i}_${j}mm_13TeV_2018MC_MiniAod
    end
end
