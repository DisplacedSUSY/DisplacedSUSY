...
config.General.requestName = 'staus_M_XXX_YYYmm_13TeV_2017MC_Reco'
...
config.Data.inputDataset = '/Staus_LeptonFilter_M_XXX_YYYmm_13TeV_2017MC/jalimena-DigiRawHlt-/USER'
