#ifndef SLEPTONSIMPATANALYZER

#define SLEPTONSIMPATANALYZER
...
class SleptonSimPatAnalyzer : public edm::EDAnalyzer {
 public:
  explicit SleptonSimPatAnalyzer (const edm::ParameterSet &);
  ~SleptonSimPatAnalyzer ();
