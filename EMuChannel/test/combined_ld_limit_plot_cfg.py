...
plotDefinitions = [
    {
        ...
        'th2fs' : [
            {
                'source' : ['combined_ld_runII_29Jan2021'],
                'th2fsToInclude' : ['exp'],
            },
        ],
        'graphs' : [
    ...
    # summary plot of all three channels
    {
        ...
        'graphs' : [
            ...
            {
                'source' : ['emu_ld_runII_29Jan2021'],
                'graphsToInclude' : ['exp'],
                'colorScheme' : 'yellow',
                'legendEntry' : 'e#mu channel'
            },
            {
                'source' : ['ee_ld_runII_29Jan2021'],
                'graphsToInclude' : ['exp'],
                'colorScheme' : 'blue',
                'legendEntry' : 'ee channel'
            },
            {
                'source' : ['mumu_ld_runII_29Jan2021'],
                'graphsToInclude' : ['exp'],
                'colorScheme' : 'green',
