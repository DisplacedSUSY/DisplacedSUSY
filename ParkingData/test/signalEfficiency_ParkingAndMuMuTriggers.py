...
c = TCanvas("sigEff", "sigEff", 200, 10, 500, 300)
...
hEff_parking.SetMarkerStyle(21)
...
hEff_mumu.SetMarkerColor(6)
hEff_parking.GetYaxis().SetRangeUser(0, 10)
...
leg = TLegend(0.15,0.75,0.5,0.85)
leg.AddEntry(hEff_parking, "parking data trigger", "lp")
leg.AddEntry(hEff_mumu, "mumu data trigger", "lp")
leg.Draw()
