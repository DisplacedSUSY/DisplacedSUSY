...
muon_idExcept1PixelHit_cut.numberRequired = cms.string(">= 2")
muon_idExcept1PixelHit_cut.alias = cms.string(">=2 muons with tight ID except 1 pixel hit requirement")
