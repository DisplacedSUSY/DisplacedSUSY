...
from DisplacedSUSY.Configuration.histogramDefinitions import MuonD0Histograms, MuonPhotonHistograms, MuonTimingHistograms, MuonDeltaTimingHistograms
...
histograms.append(MuonTimingHistograms)
histograms.append(MuonDeltaTimingHistograms)
